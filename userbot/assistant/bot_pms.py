    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"اهلا ! 👤{mention},\
                        ...
                        \n\nتم صنع بواسطه  سورس [دايفل](https://t.me/R125R)"
        buttons = [
            (
                Button.url("الريبو", "https://t.me/R125R"),
                Button.url(
                    "المطور",
                    "https://t.me/R125R",
                ),
