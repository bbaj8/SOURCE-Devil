    ...
    try:
        async with bot.conversation(chat) as conv:
            try:
                ...
                filename = await conv.send_message("R125R")
...
async def _(iqthon):
    ...
    async with iqthon.client.conversation(chat) as conv:
        try:
            ...
            await iqevent.edit("**⎈ ⦙  فك الحظر من البوت : @Y071bot**")
            return
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("** تحـقق من انـك لم تقـم بحظر البوت @Uii1obot .. ثم اعـد استخدام الامـر ... ♥️**")
            return
